...
public class ABA {
     ...
     * 类似oracle的乐观锁中的多版本控制！ 构造方法中，第一个参数为reference，第二个为stamp的初始化值！int类型
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread refT1 = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                System.out.println(
                        "refT2stamp init value: " + atomicStampedRef.getReference());    // 100
                ...
                System.out.println(
                        "refT1stamp value first: " + atomicStampedRef.getReference());    // 101
                ...
                System.out.println(
                        "refT1stamp value second: " + atomicStampedRef.getReference());    // 100
            }
        });
        ...
        Thread refT2 = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                System.out.println(
                        "refT2stamp: " + stamp); // stamp = 0 说明他对应的版本号为0 而当refT1运行完以后，对应的版本号为1所以不行
                System.out.println(
                        "refT2stamp init value: " + atomicStampedRef.getReference());    // 100
                try {
                ...
                System.out
                        .println("refT2stamp value: " + atomicStampedRef.getReference());    // 100
            }
        });
