...
public class TestHuman {
    ...
    public static void main(String[] args) {
        ...
        // 错误的
        // classCast.Male m1 = (classCast.Male) new classCast.TestHuman(); // java.lang.ClassCastException
...
class Male extends TestHuman {
    @Override
    public void sleep() {
        System.out.println("classCast.Male sleep..");
    }

    public void speak() {
        System.out.println("I am classCast.Male");
    }
}
